...
/**
 * Created by CHEKN on 2018-12-31.
 */
public class Apt6Activity extends AppCompatActivity {
    ...
    public void create(String fileName){
        ...
        if (!file.exists()){
            ...
            Toast.makeText(Apt6Activity.this,"文件夹创建成功",Toast.LENGTH_LONG).show();
        }else{
            Toast.makeText(Apt6Activity.this,"文件夹已存在",Toast.LENGTH_LONG).show();
        }
    }
}